...
public class Filosofo extends Thread {
    ...
    public Filosofo(String nombre, Tenedor izquierdo, Tenedor derecho, boolean invertido) {
        super(nombre);
    ...
    private void comer() {
    	Tenedor primero = invertido ? tenedorDerecho : tenedorIzquierdo;
        Tenedor segundo = invertido ? tenedorIzquierdo : tenedorDerecho;
    	
        synchronized (primero) {//Bloquea el tenedor izquierdo
            ...
            synchronized (segundo) {//Bloquea el tenedor derecho
