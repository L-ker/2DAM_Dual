...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < nombres.length; i++) {
            ...
            boolean invertido = (i == nombres.length - 1);
            filosofos[i] = new Filosofo(nombres[i], izq, der, invertido);//Creo el filosofo le paso el nombre y los tenedores que le tocan
